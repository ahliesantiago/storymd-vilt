...
class Work extends Model
{
    ...
    public function add(){
      ...
      // 'creator_id'
      // 'privacy'
      // 'is_complete' - 1 if expected_chapter_count == 1
      // 'expected_chapter_count'
      // 'commenting_rule'
      // 'is_comment_moderated'
      // 'word_count'
      // 'language_code'
      // 'rating_id'
      // 'completed_at' - now if expected_chapter_count == 1
      // 'created_at' - now
      // 'updated_at' - now
      ...
      // 'is_published' - 0 if work privacy is private
      // 'published_at' - now if work privacy is not private
      // 'revised_at'
      // 'created_at' - now
      // 'updated_at' - now
